...
def task_wait_n(n: int, max_delay: int) -> List[float]:
    """
    Creates and returns a list of asyncio.Tasks that execute task_wait_random with the specified max_delay.

    Args:
        n (int): The number of tasks to create.
        max_delay (int): The maximum delay value in seconds for task_wait_random.
